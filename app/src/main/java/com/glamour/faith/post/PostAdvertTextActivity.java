...
public class PostAdvertTextActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postRef_private = FirebaseDatabase.getInstance().getReference().child("Post_photos_public");
        ...
        com.facebook.ads.AdView adViews = new com.facebook.ads.AdView(PostAdvertTextActivity.this, getString(R.string.fb_placement_banner), com.facebook.ads.AdSize.BANNER_HEIGHT_50);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String mode = spinnner.getSelectedItem().toString();if(mode.equals("Who sees your Post?")){
                    ...
                    Toast.makeText(PostAdvertTextActivity.this, "Please select who sees your post", Toast.LENGTH_SHORT).show();
                    ...
                    postRef_public.child(saveRandomName).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if(task.isSuccessful()){
                               finish();
                                Toast.makeText(PostAdvertTextActivity.this, "New Post updated Successfully", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                            else
                            {

                                Toast.makeText(PostAdvertTextActivity.this, "Error Occurred", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                        }
                    });
        ...
        userRef.child(current_user_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    hashMap.put("church",church);
                    hashMap.put("Counter",count);
                    hashMap.put("postmode","advertwithtextonly");
