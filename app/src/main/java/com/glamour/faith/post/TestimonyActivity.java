...
public class TestimonyActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.facebook.ads.AdView adViews = new com.facebook.ads.AdView(TestimonyActivity.this, getString(R.string.fb_placement_banner), com.facebook.ads.AdSize.BANNER_HEIGHT_50);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String mode = spinnner.getSelectedItem().toString();if(mode.equals("Who sees your Post?")){
                    ...
                    Toast.makeText(TestimonyActivity.this, "Please select who sees your post", Toast.LENGTH_SHORT).show();
    ...
    private void ValidatePostInfoPrivate() {
     ...
     if(ImageUri == null){
            ...
            final ProgressDialog progressDialog =new ProgressDialog(TestimonyActivity.this);
                        ...
                        if(snapshot.exists()){
                            ...
                            postRef_public.child(saveRandomName).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    if(task.isSuccessful()){
                                        finish();
                                        Toast.makeText(TestimonyActivity.this, "Photo Posted Successfully", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                    }
                                    else
                                    {

                                        Toast.makeText(TestimonyActivity.this, "Error Occurred", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                    }
