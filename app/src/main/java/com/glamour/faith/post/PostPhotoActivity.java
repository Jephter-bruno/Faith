...
public class PostPhotoActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.facebook.ads.AdView adViews = new com.facebook.ads.AdView(PostPhotoActivity.this, getString(R.string.fb_placement_banner), com.facebook.ads.AdSize.BANNER_HEIGHT_50);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String mode = spinnner.getSelectedItem().toString();if(mode.equals("Who sees your Post?")){
                    ...
                    Toast.makeText(PostPhotoActivity.this, "Please select who sees your post", Toast.LENGTH_SHORT).show();
                }
        }
        });
    ...
    /*    if(TextUtils.isEmpty(text)){
            ...
            final ProgressDialog progressDialog =new ProgressDialog(PostPhotoActivity.this);
                            ...
                            postRef_public.child(saveRandomName).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    ...
                                    else
                                    {
                                        ...
                                        Toast.makeText(PostPhotoActivity.this, "Error Occurred", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                    }
