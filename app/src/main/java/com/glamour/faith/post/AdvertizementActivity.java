...
public class AdvertizementActivity extends AppCompatActivity implements
        AdapterView.OnItemSelectedListener {
    String[] church = {"Who sees your Post?,", "Everyone", "My Church Members Only"};
    String[] mode = {"Text and Image","Text only", "Image Only"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advertizement);
        ...
        com.facebook.ads.AdView adViews = new com.facebook.ads.AdView(AdvertizementActivity.this, getString(R.string.fb_placement_banner), com.facebook.ads.AdSize.BANNER_HEIGHT_50);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String mode = spinnner.getSelectedItem().toString();if(mode.equals("Who sees your Post?")){
                    ...
                    Toast.makeText(AdvertizementActivity.this, "Please select who sees your post", Toast.LENGTH_SHORT).show();
 ...
 if(ImageUri == null){
            ...
            final ProgressDialog progressDialog =new ProgressDialog(AdvertizementActivity.this);
                            ...
                            postRef_public.child(saveRandomName).updateChildren(hashMap).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(AdvertizementActivity.this, "Photo Posted Successfully", Toast.LENGTH_SHORT).show();
                                        finish();
                                        loadingBar.dismiss();
                                    }
                                    else
                                    {
                                        ...
                                        Toast.makeText(AdvertizementActivity.this, "Error Occurred", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                    }
                ...
                reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            hashMap.put("search",username.toLowerCase());
                            postRef_public.addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    if(snapshot.exists()){
